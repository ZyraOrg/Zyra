import{cE as I,dj as l,cH as w,cI as P,cJ as A,c_ as v,cQ as h,cK as u,d4 as z,cX as R,cT as $,d0 as K,dX as M,cY as F,cZ as Q,cF as O,cG as H,ec as L}from"./index-jf_GQHlM.js";import{S as r}from"./SwapController-BwxwkNdv.js";import"./index-DVNj3qms.js";const q={numericInputKeyDown(e,t,o){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,i=e.key,a=i.toLocaleLowerCase(),c=a==="a",C=a==="c",V=a==="v",W=a==="x",E=i===",",_=i===".",N=i>="0"&&i<="9";!s&&(c||C||V||W)&&e.preventDefault(),t==="0"&&!E&&!_&&i==="0"&&e.preventDefault(),t==="0"&&N&&(o(i),e.preventDefault()),(E||_)&&(t||(o("0."),e.preventDefault()),(t?.includes(".")||t?.includes(","))&&e.preventDefault()),!N&&!n.includes(i)&&!_&&!E&&e.preventDefault()}},G=I`
  :host {
    width: 100%;
  }
