import{dX as x,ef as te,cT as c,cV as ne,cE as g,cF as j,cI as m,cJ as b,cK as d,cH as l,di as k,d2 as z,dj as u,cG as se,c_ as f,cM as D,dg as L,eb as le,e1 as V,cX as U,dU as R,d6 as F,cP as ce,cU as A,dZ as T,e8 as q,dh as de,cO as ie,eg as ue,eh as he}from"./index-BYuaO2iC.js";import{P as _}from"./index-BYPplJS7.js";import{S as pe}from"./SwapController-CGw2F9de.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
