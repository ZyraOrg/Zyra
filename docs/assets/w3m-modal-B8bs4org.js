import{d$ as x,er as te,cU as c,cW as ne,cG as g,cH as j,cK as m,cL as b,cM as d,cJ as l,dm as k,d3 as z,dn as u,cI as se,c$ as f,cO as D,dk as L,en as le,e5 as V,cY as U,dY as R,d7 as F,cR as ce,cV as A,e1 as T,ek as q,dl as de,cQ as ie,es as ue,et as he}from"./index-R8UvB1D5.js";import{P as _}from"./index-DFYBNjBv.js";import{S as pe}from"./SwapController-CH-_gn0u.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
