<<<<<<<< HEAD:docs/assets/socials-CKFwFPql.js
import{cG as L,cJ as k,dn as l,cK as O,cL as _,d7 as E,dY as h,e1 as W,cU as f,d5 as T,cM as c,e2 as F,d1 as v,e3 as D,d3 as N,e4 as R,dm as $,c$ as d,cW as S,e5 as M,cY as u,e6 as U,cV as C,e7 as j,d$ as I,dl as x}from"./index-AR2iM5MW.js";const q=L`
========
import{cE as L,cH as k,dl as l,cI as O,cJ as I,d5 as E,dE as h,dJ as W,cS as f,d3 as T,cK as c,dK as F,c$ as v,dL as D,d1 as N,dM as R,dk as $,cZ as d,cU as S,dN as j,cW as u,dO as U,cT as C,dP as M,dH as _,dj as x}from"./index-DFJFoxns.js";const q=L`
>>>>>>>> f110949 (Update):docs/assets/socials-D-W2g1aZ.js
  :host {
...
`;var A=function(t,e,i,r){var s=arguments.length,o=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o};let P=class extends I{constructor(){super(),this.unsubscribe=[],this.checked=R.state.isLegalCheckboxChecked,this.unsubscribe.push(R.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:i}=h.state,r=h.state.features?.legalCheckbox,n=!!(e||i)&&!!r&&!this.checked,a=n?-1:void 0;return c`
    ...
    `}};P.styles=z;A([l()],P.prototype,"checked",void 0);P=A([O("w3m-connect-socials-view")],P);const B=L`
  wui-logo {
    width: 80px;
    height: 80px;
