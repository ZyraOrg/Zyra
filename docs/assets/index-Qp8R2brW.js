import{cE as U,cF as ye,cG as Se,cH as b,cI as _,cJ as C,di as g,cK as l,cW as I,ei as Pe,cV as T,ej as Te,ek as w,d0 as O,el as ve,em as N,dU as ie,cQ as A,en as ue,c_ as m,cS as ke,dg as P,cX as W,cU as R,d3 as _e,dX as z,d7 as Ce,d8 as $e,d6 as S,cT as M,dj as h,cM as Re,cO as Oe,eo as xe,cP as Ue,ec as le}from"./index-CDFuvhvR.js";const Le=U`
  :host {
    position: relative;
  }
...
`;var j=function(t,e,n,s){var a=arguments.length,i=a<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,s);else for(var u=t.length-1;u>=0;u--)(o=t[u])&&(i=(a<3?o(i):a>3?o(e,n,i):o(e,n))||i);return a>3&&i&&Object.defineProperty(e,n,i),i};const rt=3,ot=2,ct=.3,ut="200px",lt={"accent-primary":Re.tokens.core.backgroundAccentPrimary};let q=class extends C{constructor(){super(...arguments),this.rings=rt,this.duration=ot,this.opacity=ct,this.size=ut,this.variant="accent-primary"}render(){const e=lt[this.variant];this.style.cssText=`
    ...
    `}renderRing(e,n){const a=`animation-delay: ${e/n*this.duration}s;`;return l`<div class="pulse-ring" style=${a}></div>`}};q.styles=[ye,at];j([b({type:Number})],q.prototype,"rings",void 0);j([b({type:Number})],q.prototype,"duration",void 0);j([b({type:Number})],q.prototype,"opacity",void 0);j([b()],q.prototype,"size",void 0);j([b()],q.prototype,"variant",void 0);q=j([_("wui-pulse")],q);const fe=[{id:"received",title:"Receiving funds",icon:"dollar"},{id:"processing",title:"Swapping asset",icon:"recycleHorizontal"},{id:"sending",title:"Sending asset to the recipient address",icon:"send"}],we=["success","submitted","failure","timeout","refund"],dt=U`
  :host {
    display: block;
    height: 100%;
    width: 100%;
