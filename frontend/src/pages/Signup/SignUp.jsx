...
export default function ZyraSignUp() {
    ...
    <div className="h-[100dvh] bg-background flex justify-center overflow-hidden">
      ...
      <div className="relative flex flex-col justify-center w-full max-w-md p-8 bg-background rounded-2xl md:max-w-full md:w-1/2">
        ...
        <div className="mb-8 text-center md:hidden">
          <h1 className="mb-4 text-3xl font-bold text-white" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="0">
            Create Your <span className="text-secondary">Zyra</span> Account
          </h1>
          <p className="text-sm text-gray-400" data-aos="fade-down" data-aos-duration="800" data-aos-delay="0">
            Sign up to create campaigns, donate securely, and track every
            transaction on-chain.
          </p>
        </div>

        <h2 className="hidden mb-8 text-2xl font-semibold text-white md:block" data-aos="fade-down" data-aos-duration="1500" data-aos-delay="0">
          Sign up now
        </h2>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div>
            <input
              data-aos="slide-left" data-aos-duration="700" data-aos-delay="0"
              type="text"
              name="name"
          ...
          <div>
            <input
              data-aos="slide-left" data-aos-duration="800" data-aos-delay="0"
              type="email"
              name="email"
          ...
          <div>
            <div className="relative">
              <input
                data-aos="slide-left" data-aos-duration="900" data-aos-delay="0"
          ...
          <div>
            <div className="relative">
              <input
                data-aos="slide-left" data-aos-duration="1000" data-aos-delay="0"
  ...
  className="w-full bg-gradient-to-r from-[#0A36F7] to-[#91F2F9] text-black text-[1.2rem] font-bold py-3 rounded-[10px] 
            ...
            data-aos="fade-up" data-aos-duration="1000" data-aos-delay="0"
>
  Sign up
</button>
  ...
  <div className="flex items-center gap-4 text-sm text-gray-500">
    ...
    <span data-aos="fade-up" data-aos-delay="400">or sign up with</span>
    <div className="flex-1 h-px bg-gray-700" data-aos="fade-up" data-aos-delay="300"></div>
  </div>
