  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Buttons */}
        <div className="flex flex-col items-center gap-4 mt-8 sm:flex-row md:items-start">
          <button
          ...
          <button
            className="flex items-center justify-center gap-2 px-10 py-5 min-w-[220px] md:min-w-[200px] 
      ...
      >
        ...
        >
          <img
            src={Shielding2}
            alt="Verified users"
            className="object-contain w-full h-full top-[70%] flex"
          />
        </div>
        ...
        <div className="flex flex-row justify-between w-full max-w-[320px] md:max-w-none md:justify-start md:gap-6">
          ...
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 bg-[#91F2F9] rounded-full"></span>
            <span className="text-sm font-medium text-white font-sora">
