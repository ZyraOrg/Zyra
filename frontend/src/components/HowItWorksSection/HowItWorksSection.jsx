  ...
  return (
    <main id="create" className="flex flex-col items-center justify-center w-full px-5 overflow-x-hidden overflow-y-hidden text-center md:mt-10 md:px-10">
      ...
      <div className="pb-5 space-y-5">
        <h1
          className="text-2xl font-semibold md:text-5xl md:leading-15"
          data-aos="fade-up"
        ...
        <p
          className="text-[11px] md:text-[16px] font-semibold"
          data-aos="zoom-in"
          data-aos-duration="800"
        >
      ...
      <div
        className="flex flex-col items-center justify-center gap-10 pt-8 text-center md:pt-12 md:gap-15"
        data-aos="fade-up"
        data-aos-delay="200"
      >
        {" "}
