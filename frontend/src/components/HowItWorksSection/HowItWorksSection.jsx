...
const HowItWorksSection = () => {
  ...
  return (
    <main className="flex flex-col items-center justify-center w-full px-5 overflow-x-hidden overflow-y-hidden text-center md:mt-10 md:px-10">  {/* Add overflow-y-hidden */}
      <div className="pb-5 space-y-5">
        <h1 className="text-2xl font-semibold md:text-5xl md:leading-15" data-aos="fade-up" data-aos-duration="800">
          How It <span className="text-secondary">Works</span>
        </h1>
        <p className="text-[11px] md:text-[16px] font-semibold" data-aos="zoom-in" data-aos-duration="800">
          Four simple steps to transparent, blockchain-powered{" "}
          <br className="hidden md:block" />
          crowdfunding
        </p>
      </div>
      <div className="flex flex-col items-center justify-center gap-10 pt-8 text-center md:pt-12 md:gap-15" data-aos="fade-up" data-aos-delay="200">  {/* AOS here */}
        <div className="flex flex-col items-center justify-between gap-10 text-center md:flex-row md:w-2xl">
          <div className="flex flex-col items-center justify-center gap-5">  {/* No AOS */}
      ...
      <button className="mt-16 transition-transform duration-300 ease-in-out shadow-sm border-button-gradient hover:scale-101" data-aos="fade-up" data-aos-duration="800">
